...
##run dictionary: eg. /p200/liuxin_group/moshl/Temp/TCGA/HM/MM
##usage perl ../../Code/SplitMAF_HM_MM_bySample.pl ./data_clinical_patient.txt ./data_clinical_sample.txt ./data_mutations_mskcc.txt 
