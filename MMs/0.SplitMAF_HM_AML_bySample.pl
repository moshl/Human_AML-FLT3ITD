...
#1.选择满足条件样本: 原发性肿瘤 & #2.选择具有突变数据的样本
...
##run dictionary: eg. /p200/liuxin_group/moshl/Temp/TCGA/HM
##usage perl ../Code/SplitMAF_HM_bySample.pl ./data_clinical_sample.txt ./data_mutations_mskcc_rmdup.txt > IsDupSampleInfo.txt
