...
##run dictionary: eg. /p200/liuxin_group/moshl/Temp/TCGA/HM/CLL2
##usage perl ../../Code/SplitMAF_HM_CLL2_bySample.pl ./data_clinical_sample.txt ./data_mutations_mskcc.txt 
