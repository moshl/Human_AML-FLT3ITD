...
##run dictionary: eg. /p200/liuxin_group/moshl/Temp/TCGA/HM/DLBC
##usage perl ../../Code/SplitMAF_HM_DLBC_bySample.pl ./data_clinical_sample.txt ./data_mutations_mskcc.txt 
